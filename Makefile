...
# akuity.com/ns-operator-bundle:$VERSION and akuity.com/ns-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= akuity.com/ns-operator
...
## marker
	cat target/kubernetes/namespaceclasses.akuity.io.akuity.com-v1.yml target/kubernetes/kubernetes.yml | operator-sdk generate bundle -q --overwrite --version $(VERSION) $(BUNDLE_METADATA_OPTS)
