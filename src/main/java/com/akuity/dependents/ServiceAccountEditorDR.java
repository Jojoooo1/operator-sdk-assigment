...
@KubernetesDependent(
    ...
    resourceDiscriminator = ServiceAccountEditorDR.Discriminator.class)
public class ServiceAccountEditorDR
    extends CRUDKubernetesDependentResource<ServiceAccount, Namespace>
    implements SecondaryToPrimaryMapper<ServiceAccount> {

  public static final String COMPONENT = "sa-editor";

  public ServiceAccountEditorDR() {
