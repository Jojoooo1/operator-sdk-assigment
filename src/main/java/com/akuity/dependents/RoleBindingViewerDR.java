...
@KubernetesDependent(
    ...
    resourceDiscriminator = RoleBindingViewerDR.Discriminator.class)
public class RoleBindingViewerDR extends CRUDKubernetesDependentResource<RoleBinding, Namespace>
    implements SecondaryToPrimaryMapper<RoleBinding> {

  public static final String COMPONENT = "role-binding-viewer";

  public RoleBindingViewerDR() {
  ...
  public RoleBinding desired(final Namespace primary, final Context<Namespace> context) {
    ...
    return new RoleBindingBuilder()
        ...
        .withName(ResourceUtils.name(primary, ServiceAccountViewerDR.COMPONENT))
        .withNamespace(primary.getMetadata().getName())
        .endSubject()
        .withNewRoleRef()
        .withKind("Role")
        .withName(ResourceUtils.name(primary, RoleViewerDR.COMPONENT))
