...
@KubernetesDependent(
    ...
    resourceDiscriminator = RoleEditorDR.Discriminator.class)
public class RoleEditorDR extends CRUDKubernetesDependentResource<Role, Namespace>
    implements SecondaryToPrimaryMapper<Role> {

  public static final String COMPONENT = "role-editor";
