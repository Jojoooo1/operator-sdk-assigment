...
@KubernetesDependent(
    ...
    resourceDiscriminator = RoleBindingAdminDR.Discriminator.class)
public class RoleBindingAdminDR extends CRUDKubernetesDependentResource<RoleBinding, Namespace>
    implements SecondaryToPrimaryMapper<RoleBinding> {

  public static final String COMPONENT = "role-binding-admin";

  public RoleBindingAdminDR() {
  ...
  public RoleBinding desired(final Namespace primary, final Context<Namespace> context) {
    ...
    return new RoleBindingBuilder()
        ...
        .withName(ResourceUtils.name(primary, ServiceAccountAdminDR.COMPONENT))
        .withNamespace(primary.getMetadata().getName())
        .endSubject()
        .withNewRoleRef()
        .withKind("Role")
        .withName(ResourceUtils.name(primary, RoleAdminDR.COMPONENT))
