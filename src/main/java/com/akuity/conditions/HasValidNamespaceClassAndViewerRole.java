...
@Slf4j
public class HasValidNamespaceClassAndViewerRole<R extends HasMetadata>
  ...
  public boolean isMet(
    ...
    // 2. Verify viewer role is passed to the CRD
    return hasAllowedRole(dependentResource, primary, context, RoleEnum.VIEWER);
  }
}
