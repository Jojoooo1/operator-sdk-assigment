...
@Slf4j
public class HasValidNamespaceClassAndAdminRole<R extends HasMetadata>
  ...
  public boolean isMet(
    ...
    // 2. Verify admin role is passed to the CRD
    return hasAllowedRole(dependentResource, primary, context, RoleEnum.ADMIN);
  }
}
